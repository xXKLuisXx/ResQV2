            ...
            <div style="padding: 5px; width: 100%;">
                <form action="{{action('MensajeController@store')}}" method="POST">
                    ...
                    <div class="flex">
                        ...
                        <input class="mx-2 my-2 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="text" type="text" required>
                        <div class="mx-2 text-xl self-center">
                            <button class="AddComment" type="submit"><i class="far fa-paper-plane"></i></button>
                        </div>
                    </div>
                </form>
            </div>
